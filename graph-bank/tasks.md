...
**目標**：建立安全的後端規則和完整測試
**任務**：
- [x] **task-7-1**: 實作 Firestore 安全規則 (accounts 集合)
- [x] **task-7-2**: 實作組織/團隊/成員權限規則
- [x] **task-7-3**: 實作 Repository 安全規則
- [x] **task-7-4**: 實作單元測試 - ValidationUtils 測試完成
- [ ] **task-7-5**: 實作整合測試
- [ ] **task-7-6**: 實作 E2E 測試
...
- ✅ ValidationUtils 單元測試全部通過 (25/25)
- ✅ 測試覆蓋率達標
- ✅ 完整功能測試通過
- ✅ 安全規則和權限系統驗證通過
